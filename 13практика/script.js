    ...
    contents.onclick = function(event) {
        ...
        function handleLink(href) {
          let isLeaving = confirm(`Перейти по ссылочке ${href}?`);
      ...
      var Count=0;
      let storageMock = [
      {id: 1, name: "Яблочный сидр", price: 120},
      {id: 2, name: "Красное вино", price: 12000},
      {id: 3, name: "Коньяк Арарат", price: 2000},
      {id: 4, name: "Мартини", price: 500},
      {id: 5, name: "Виски", price: 5000}];
      ...
      function fillStorageTable(items) {
          ...
          itemTR.innerHTML = `<td>${e.id}</td><td>${e.name}</td><td>${e.price}</td>`;
    ...
    function addToCart() {
      ...
      document.getElementById('count').innerHTML = Count;
        ...
        cartTR.innerHTML = `<td>${this.childNodes[1].textContent}</td><td>${this.childNodes[2].textContent}</td>`;
